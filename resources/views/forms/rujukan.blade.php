          ...
          <div class="max-w-7xl mx-auto md:px-12 lg:px-9">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 text-sm font-bold">
                  ...
                  <form class="w-full max-w-sm" method="POST" action="{{ route('storeRujukan') }}">
                  @csrf
                  ...
                  <table class="w-full tr-even:bg-grey-light">
                    ...
                    <tr class="border">
                      <td><strong>Hasil Lot Dituai (Kg)</strong></td>
                      <td><input type="text" name="hasilLot" required=""></td>
                    </tr>
                    <tr class="border">
                      <td><strong>Hasil (Kg/Hektar)</strong></td>
                      <td><input type="text" name="hasilKgHektar" required=""></td>
                    </tr>
