            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form class="w-full max-w-sm">
                  ...
                  <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                      <textarea class="bg-gray-200 appearance-none border-gray-200 focus:bg-white appearance-none border-2 rounded w-full focus:outline-none leading-tight focus:border-purple-500"></textarea>
                    </div>
                  </div>                  
